...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://platform.linkedin.com https://static.licdn.com",
      ...
      "connect-src 'self' https://*.amazonaws.com https://*.linkedin.com https://*.licdn.com https://api.microlink.io",
      "frame-src https://www.youtube.com https://www.youtube-nocookie.com https://www.linkedin.com https://docs.google.com",
